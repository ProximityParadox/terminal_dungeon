...
import { stat_calc } from "./bin/Function_states_module.js";
import calculate_stat_usage from './bin/stat_calc_module.js';
...
describe("#calculates basic str, con and dex stats into game values like dmg", function () {
    it ("Preset test 1", function() {
